function omega=optimalni(n,tol,maxit)
    ...
    %omega_sred_1 = (omega_2 - omega_1) * 1/3  + omega_1;
    %omega_sred_2 = (omega_2 - omega_1) * 2/3  + omega_1;
    %st_iter_sred_1 = bessel_za_optimalni(5, 8, 95, 5, n, tol, maxit, omega_sred_1);
    %st_iter_sred_2 = bessel_za_optimalni(5, 8, 95, 5, n, tol, maxit, omega_sred_2);

    omega_sred = (omega_2 - omega_1) * 1/2  + omega_1;
    st_iter_sred = bessel_za_optimalni(5, 8, 95, 5, n, tol, maxit, omega_sred);

    while (omega_2 - omega_1) > 0.01
        if st_iter_sred <= st_iter_1
            omega_1 = omega_sred;
